...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "main_logo_dark.png")), size=(26, 26))
        ...
        self.home_frame_large_image_label = customtkinter.CTkLabel(self.home_frame, text="tkharbi9 of home")
